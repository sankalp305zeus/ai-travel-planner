...
if config.GROQ_API_KEY and config.GROQ_API_KEY != "mock_key":
    ...
    agent = Agent(
        ...
        system_prompt=(
            ...
            "- Currency: Determine the budget currency. If a number is given without a currency code (e.g. '200000'), ASSUME INR (the default).\n"
            "  Examples:\n"
            "    '200000' -> INR (default)\n"
            "    '$2000' or '2000 USD' -> USD\n"
            "    '₹2,00,000' -> INR\n"
            "    '€1500' or '1500 EUR' -> EUR\n"
